...
class BesinListesiFragment : Fragment() {
    ...
    private val reyclerBesinAdapter=BesinRecyclerAdapter(arrayListOf())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        BesinlistRecycler.adapter=reyclerBesinAdapter
    ...
    fun observeLiveData(){
        viewModel.besinler.observe(viewLifecycleOwner, Observer {besinler->
            besinler?.let{
                ...
                reyclerBesinAdapter.besinListesiGuncelle(besinler)
